	...
	void reservation_update(u32 addr)
	{
		...
		while (true)
		{
			...
			if (ok)
			{
				...
				// This is because reservation_update is often brought after the actual reservation
				// update and not by a fused operation; notify both the current and previous
				// reservation generation since a waiter may have registered against either.
